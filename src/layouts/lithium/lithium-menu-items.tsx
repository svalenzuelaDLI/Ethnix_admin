...
export const lithiumMenuItems: LithiumMenuItem = {
  ...
  appsKit: {
    ...
    dropdownItems: [
      ...
      {
        name: 'New customers',
        description: 'Manage all new customers information before uploaded to SAP',
        icon: 'InvoiceIcon',
        subMenuItems: [
          {
            name: 'List',
          ...
          {
            name: 'Details',
            href: routes.newcustomers.details(DUMMY_ID),
          },
          {
            name: 'Create',
            href: routes.newcustomers.create,
          },
          {
            name: 'Edit',
            href: routes.newcustomers.edit(DUMMY_ID),
          },
        ],
      },
      {
