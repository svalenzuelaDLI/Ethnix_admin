...
import CreateNewCustomersFinance from '@/app/shared/newcustomers/create-newcustomersfinance';
...
export default function CustomerEditPage({ params }: any) {
  ...
  return (
    ...
    newcustomer ? (
            ...
            <CreateNewCustomersFinance pricelistvalues={pricelistvalues} id={params.id} operationtimevalue={operationtimevalue} record={newcustomer} propertiesvalues={propertiesvalues} receivingDaysvalues={receivingDaysvalues}
