...
import EditNewProductsCommercial from '@/app/shared/newproducts/edit-newproducts-commercial';
...
export default function CustomerEditPage({ params }: any) {
  ...
  return (
    <>
      ...
      {(!loading) ? null : (
            <EditNewProductsCommercial id={params.id} record={undefined} salesreps={salesreps} salessupervisors={salessupervisors} salesroutes={salesroutes} 
